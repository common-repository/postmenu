...
class Postmenu_Loader {
	 ...
	 */
	public function add_shortcode( $hook, $component, $callback, $priority = 10, $accepted_args = 2 ) {
	...
	public function run() {
		...
		foreach ( $this->shortcodes as $hook ) {
			require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/shortcodes/' . str_replace( "_", "-", $hook['callback'] ) . '.php';
